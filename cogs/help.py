...
class HelpCog(commands.Cog):
    ...
    async def displayHelpCommand(self, ctx, page=None):
        ...
        embed7 = newEmbed(f"- {start}join``"
                          ...
                          f"\n**,play** supports _filenames__, __youtube links__ and __discord upload links__."
                          ...
                          f"\n- {start}playsearch keyword``"
                          f"\nReturns a list of files with that keyword."
                          f"\n")
    ...
    @commands.command(name="server", aliases=["Server", "SERVER"])
    @ctx_wrapper()
